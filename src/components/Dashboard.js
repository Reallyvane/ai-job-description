        ...
        <div className="">
          <form onSubmit={(e) => handleSubmit(e)}>
            <div className="flex flex-col">
              ...
              <input
                type="text"
                className="block w-full rounded-md bg-white border border-gray-400 shadow-sm focus:border-indigo-600 focus:ring-indigo-600 sm:text-sm px-4 py-2 placeholder-gray-500 my-2 text-gray-900"
                name="jobTitle"
            ...
            <button
              className={`bg-indigo-600 w-full hover:bg-indigo-700 text-white font-bold mt-6 py-2 px-4 rounded
                ${
